...
include "m8c.inc"
include "memory.inc"
include "CNT_10kHz.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  CNT_10kHz_EnableInt
export _CNT_10kHz_EnableInt
export  CNT_10kHz_DisableInt
export _CNT_10kHz_DisableInt
export  CNT_10kHz_Start
export _CNT_10kHz_Start
export  CNT_10kHz_Stop
export _CNT_10kHz_Stop
export  CNT_10kHz_WritePeriod
export _CNT_10kHz_WritePeriod
export  CNT_10kHz_WriteCompareValue
export _CNT_10kHz_WriteCompareValue
export  CNT_10kHz_bReadCompareValue
export _CNT_10kHz_bReadCompareValue
export  CNT_10kHz_bReadCounter
export _CNT_10kHz_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bCNT_10kHz_ReadCompareValue  ; deprecated
export _bCNT_10kHz_ReadCompareValue  ; deprecated
export  bCNT_10kHz_ReadCounter       ; deprecated
export _bCNT_10kHz_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CNT_10kHz_EnableInt
;
;  DESCRIPTION:
...
;
 CNT_10kHz_EnableInt:
_CNT_10kHz_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   CNT_10kHz_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CNT_10kHz_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 CNT_10kHz_DisableInt:
_CNT_10kHz_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   CNT_10kHz_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CNT_10kHz_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 CNT_10kHz_WritePeriod:
_CNT_10kHz_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[CNT_10kHz_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CNT_10kHz_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 CNT_10kHz_WriteCompareValue:
_CNT_10kHz_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[CNT_10kHz_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CNT_10kHz_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 CNT_10kHz_bReadCompareValue:
_CNT_10kHz_bReadCompareValue:
 bCNT_10kHz_ReadCompareValue:                    ; this name deprecated
_bCNT_10kHz_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[CNT_10kHz_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: CNT_10kHz_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 CNT_10kHz_bReadCounter:
_CNT_10kHz_bReadCounter:
 bCNT_10kHz_ReadCounter:                         ; this name deprecated
_bCNT_10kHz_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[CNT_10kHz_COMPARE_REG]           ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[CNT_10kHz_CONTROL_REG]           ; Save CR0 (running or stopped state)
   push  A                                       ;
   CNT_10kHz_Stop_M                              ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[CNT_10kHz_INPUT_REG]             ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[CNT_10kHz_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[CNT_10kHz_COUNTER_REG]           ; DR2 <- DR0
   mov   A, reg[CNT_10kHz_COMPARE_REG]           ; Stash the Count on the stack
   ...
   mov   reg[CNT_10kHz_INPUT_REG], A             ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[CNT_10kHz_CONTROL_REG], A           ;     this function was first called
