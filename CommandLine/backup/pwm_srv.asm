...
;  Global Symbols
;-----------------------------------------------
export  PWM_SRV_EnableInt
export _PWM_SRV_EnableInt
export  PWM_SRV_DisableInt
export _PWM_SRV_DisableInt
export  PWM_SRV_Start
export _PWM_SRV_Start
export  PWM_SRV_Stop
export _PWM_SRV_Stop
export  PWM_SRV_WritePeriod
export _PWM_SRV_WritePeriod
export  PWM_SRV_WritePulseWidth
export _PWM_SRV_WritePulseWidth
export  PWM_SRV_bReadPulseWidth
export _PWM_SRV_bReadPulseWidth
export  PWM_SRV_bReadCounter
export _PWM_SRV_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM_SRV_ReadPulseWidth    ; deprecated
export _bPWM_SRV_ReadPulseWidth    ; deprecated
export  bPWM_SRV_ReadCounter       ; deprecated
export _bPWM_SRV_ReadCounter       ; deprecated


AREA commandline_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_SRV_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_SRV_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_SRV_WritePeriod
;
;  DESCRIPTION:
...
;
 PWM_SRV_WritePeriod:
_PWM_SRV_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM_SRV_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_SRV_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM_SRV_WritePulseWidth:
_PWM_SRV_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM_SRV_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_SRV_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM_SRV_bReadPulseWidth:
_PWM_SRV_bReadPulseWidth:
 bPWM_SRV_ReadPulseWidth:                        ; this name deprecated
_bPWM_SRV_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM_SRV_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM_SRV_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM_SRV_bReadCounter:
_PWM_SRV_bReadCounter:
 bPWM_SRV_ReadCounter:                           ; this name deprecated
_bPWM_SRV_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[PWM_SRV_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   PWM_SRV_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM_SRV_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM_SRV_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM_SRV_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[PWM_SRV_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[PWM_SRV_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   PWM_SRV_Start_M                               ;   then re-enable the PWM.
