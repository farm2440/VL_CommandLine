...
export LoadConfigTBL_commandline_Bank1
export LoadConfigTBL_commandline_Bank0
export LoadConfigTBL_commandline_Ordered
AREA lit(rom, rel)
LoadConfigTBL_commandline_Bank0:
;  Instance name CNT_10kHz, User Module Counter8
;       Instance name CNT_10kHz, Block Name CNTR8(DBB01)
	db		27h, 00h		;CNT_10kHz_CONTROL_REG(DBB01CR0)
	db		25h, 64h		;CNT_10kHz_PERIOD_REG(DBB01DR1)
	db		26h, 32h		;CNT_10kHz_COMPARE_REG(DBB01DR2)
...
;  Instance name PWM_SRV, User Module PWM8
;       Instance name PWM_SRV, Block Name PWM8(DBB00)
	db		23h, 00h		;PWM_SRV_CONTROL_REG(DBB00CR0)
	db		21h, c8h		;PWM_SRV_PERIOD_REG(DBB00DR1)
	db		22h, 0fh		;PWM_SRV_COMPARE_REG(DBB00DR2)
...
;  Global Register values Bank 0
	...
	db		b5h, 21h		; Row_0_OutputDrive_0 register (RDI0SRO0)
	...
	db		ffh
LoadConfigTBL_commandline_Bank1:
;  Instance name CNT_10kHz, User Module Counter8
;       Instance name CNT_10kHz, Block Name CNTR8(DBB01)
	db		24h, 29h		;CNT_10kHz_FUNC_REG(DBB01FN)
	db		25h, 16h		;CNT_10kHz_INPUT_REG(DBB01IN)
	db		26h, 45h		;CNT_10kHz_OUTPUT_REG(DBB01OU)
;  Instance name LED_1, User Module LED
;  Instance name LED_2, User Module LED
;  Instance name LED_3, User Module LED
;  Instance name LED_4, User Module LED
;  Instance name PWM_SRV, User Module PWM8
;       Instance name PWM_SRV, Block Name PWM8(DBB00)
	db		20h, 39h		;PWM_SRV_FUNC_REG(DBB00FN)
	db		21h, 19h		;PWM_SRV_INPUT_REG(DBB00IN)
	db		22h, 46h		;PWM_SRV_OUTPUT_REG(DBB00OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
...
LoadConfigTBL_commandline_Ordered:
;  Ordered Global Register values
	...
	mov	reg[02h], 63h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
