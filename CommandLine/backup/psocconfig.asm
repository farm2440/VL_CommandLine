...
export LoadConfig_commandline
export _LoadConfig_commandline
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_commandline
	lcall	LoadConfigTBL_commandline_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration commandline
;
;    Load configuration registers for commandline.
...
;               CUR_PP
;
_LoadConfig_commandline:
 LoadConfig_commandline:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_commandline_Bank0
    mov     X, <LoadConfigTBL_commandline_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_commandline_Bank1
    mov     X, <LoadConfigTBL_commandline_Bank1
